        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <button onclick='window.location.href="../login_page/pre_register.php";' class="btn btn-primary btn-block btn-flat" style="background-color: light blue;">Register</button>  
                    </div>
                </div>
            </div>
        </div>
