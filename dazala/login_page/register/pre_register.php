...
<body class="hold-transition login-page">
    <form id="baseform" method="post"  role="form">
        <div class="login-box">
            ...
            <input type=button onClick="location.href='../register/ven_register.php'" value='Vendor'>
            <input type=button onClick="location.href='../register/cus_register.php'" value='Customer'>
            <input type=button onClick="location.href='../register/ship_register.php'" value='Shipper'>
