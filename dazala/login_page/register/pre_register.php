    ...
    <form id="baseform" method="post" role="form">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <div class="row">
                    <div class="col-xs-4">
                        <input type=button onClick="location.href='../register/ven_register.php'" value='Vendor' class="btn btn-primary btn-block btn-flat" style="background-color: blue;">
                    </div>
                    <div class="col-xs-4">
                        <input type=button onClick="location.href='../register/cus_register.php'" value='Customer' class="btn btn-primary btn-block btn-flat" style="background-color: blue;">
                    </div>
                    <div class="col-xs-4">
                        <input type=button onClick="location.href='../register/ship_register.php'" value='Shipper' class="btn btn-primary btn-block btn-flat" style="background-color: blue;">
                    </div>
                </div>
            </div>
        </div>
