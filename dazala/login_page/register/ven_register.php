...
if (isset($_POST['act'])) {
    ...
    $sql = "INSERT INTO vendor(name, address, latitude, longtitude, username, password)
    ...
    if ($stmt->rowCount() > 0) {
        ...
        echo '<script>
            ...
            window.location.href="../login_page/register/ven_register.php";
        </script>';
    }
}
