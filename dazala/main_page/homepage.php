...
echo "ID: " . $row['id']. "<br>name: " . $row['name']. "<br>address: " . $row['address']. "<br>latitude: " . $row['latitude']. "<br>longtitude: " . $row['longtitude']. "<br>username: " . $row['username']. "<br>password: " . $row['password']. "<br><br>";

?>

<a href="update_cus_info.php">Update Information</a><br><br>
...
<section class="products">
    ...
    <a href="history_order.php">Check history orders</a><br><br>
