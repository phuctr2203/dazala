...
$id_sql = "SELECT id FROM vendor WHERE username = '$username'";
$stmt = $vendor->query($id_sql);
...
if (isset($_POST['act'])) {
    ...
    $sql = "INSERT INTO product (name, price, quantity, ven_id) VALUES ('$name', $price, $quantity, '$id_used')";
    ...
    if ($stmt->rowCount() > 0) {
        echo "<script>
            ...
            window.location.href='vendor_product.php?username=$username';
        </script>";
    } else {
        echo "<script>
    ...
    <form id="baseform" method="post"  role="form">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <button type="submit" name="act" value="INSERT" class="btn btn-primary btn-block btn-flat" style="background-color: maroon;">Add Product</button>
                    </div>
                    <div class="col-xs-6">
