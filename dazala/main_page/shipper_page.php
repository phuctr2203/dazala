...
echo "<a href='processed_order.php'>Check Processed Orders</a><br><br>";
...
foreach($rows as $row) {
    ...
    echo "<a href='shipped_order.php?id=$id' >Order Shipped</a><br>";
    echo "<a href='cancel_order.php?id=$id' >Order Cancelled</a><br>";        
}
